...
| 方案 | 配置 | 成本 | 优缺点 |
|------|------|------|--------|
| A. 云 VPS（推荐） | 3 x 2C2G | ~60-100 元/月 | 真实公网 IP，可体验完整 Ingress；学生优惠更低 |
| B. 本地虚拟机 | 3 x 2C2G VM | 免费 | 零成本可重建；无公网 IP，Ingress 用 Hosts 模拟 |
| C. 混合方案 | 1 VPS + 2 本地 VM | ~20-30 元/月 | 兼顾成本与真实网络 |
